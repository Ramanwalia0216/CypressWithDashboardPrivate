...
const videoFolder = cypressConfig.videosFolder
const reportFiles = `${reportDir}/*.json`
const videoFiles = `${videoFolder}/*.mp4`
// list all of existing report files
ls(reportFiles, { recurse: true }, file => console.log(`removing ${file.full}`))
// list all of existing video files
ls(videoFiles, { recurse: true }, file => console.log(`removing ${file.full}`))
